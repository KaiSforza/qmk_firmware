...
[3] = LAYOUT_75_ansi(
    ...
    KC_CAPS,    RGB_MOD,    RGB_VAD,    RGB_HUI,   _______,    _______,     _______,   KC_P1,      KC_P2,       KC_P2,     _______,    _______,                             KC_PENT,    KC_VOLU,
    TT(4),                  _______,    _______,   RGB_TEST,   _______,     BAT_NUM,   _______,    KC_P0,       KC_PCMM,   KC_PDOT,    _______,                 _______,    KC_MUTE,    KC_VOLD,
    _______,    KC_APP,     _______,                                        _______,                            TT(4),     TT(3),      KC_RGUI,                 KC_MPRV,    KC_MPLY,    KC_MNXT),

// layer 4
[4] = LAYOUT_75_ansi(
    _______,    _______,    _______,    _______,   _______,    _______,     _______,   _______,    _______,     _______,   _______,    _______,     _______,    SLEEP_MODE, DEV_RESET,  _______,
    _______,    _______,    _______,    _______,   _______,    _______,     _______,   _______,    _______,     _______,   _______,    _______,     _______,                RF_DFU,     _______,
    _______,    SIDE_SPD,   SIDE_VAI,   SIDE_SPI,  _______,    _______,     _______,   _______,    _______,     _______,   _______,    _______,     _______,                _______,    _______,
